...
export default function TradingJourney() {
  const journey = [
    { year: "2013", desc: "Began exploring Bitcoin mining & trading. Learned market psychology & volatility." },
    { year: "2017", desc: "Dived into Ethereum & ICOs. Gained experience in risk management." },
    { year: "2020", desc: "Integrated Forex strategies with DeFi yield farming. Built trading bots." },
    { year: "2023+", desc: "Learning Rust & Web3 development. Goal: combine trading + coding for fintech apps." },
  ];
