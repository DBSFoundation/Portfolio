...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative flex flex-col md:flex-row items-center justify-center text-center md:text-left py-32 sm:py-40 lg:py-48 bg-cover bg-center"
      style={{
        backgroundImage: "url('/images/crypto-bg.jpg')", // ganti sesuai background Anda
      }}
    >
      {/* Overlay transparan */}
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start md:gap-12 max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 text-lg sm:text-xl text-gray-200 max-w-lg">
